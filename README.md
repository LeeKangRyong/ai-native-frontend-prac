...
모바일 앱(`prac-fe-app-driver`, `prac-fe-app-user`)의 `.ai/` 디렉토리는 AI 워크플로우의 컨텍스트 소스다.  
...
- **figma-design-workflow**
  ...
  `.ai/API.md`, `.ai/DESIGN.md`, `.ai/CONVENTIONS.md`를 파싱하여 디자인 제안을 구조화하고, 인간 승인 후 Figma MCP로 화면을 생성하는 skill. (모바일 앱 전용)  
...
- **frontend-commit-push**
  ...
  lint → `frontend-tdd-runner` pre-flight 통과 후 AngularJS 컨벤션에 맞게 커밋하고 feature branch에 push하는 skill.  
